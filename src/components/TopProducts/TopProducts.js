    ...
    <div>
        <div className='container'>
            ...
            <div  className="text-left mb-24">
                ...
                <p  data-aos="fade-up" className="text-xs text-gray-400">lorem His Life will forever be Changed dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            </div>
            {/* body section.... */}
